...
Geany
скачиваем [отсюда](https://wiki.geany.org/tags/start) следующие файлы

browser.js.tags  node-v0.8.16.js.tags  std.js.tags jquery.js.tags std.css.tags

кладем их в папку 

~/.config/geany/tags

и после ввода 4-х символов начинает работать предложение выбрать продолжение
-----------------------------------
~/.config/geany/snippets.conf
находим и редактируем, например так:
...
если что  [справка тут](https://www.geany.org/manual/0.19_ru/index.html)
